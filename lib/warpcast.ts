...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    frame: {
      ...
      subtitle: "Accept crypto payments easily", // 30 characters, no emojis or special characters, short description under app name
      description: "Mini-POS for SMBs to accept USDC payments via QR codes and manage treasury with simple allocation tools on Base Sepolia", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "Mini-POS for SMBs. Accept USDC payments via QR codes and manage treasury on Base Sepolia testnet.", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
